    ...
    <div className="bg-white min-h-screen py-16">
      <Container>
        <div className="max-w-3xl prose prose-sm prose-headings:font-display prose-headings:text-navy prose-a:text-teal">
          ...
          <h2>1. Agreement</h2>
          <p>By submitting a listing application to TopGeriatricians.com, you agree to these Terms of Service. These terms govern your listing on the TopGeriatricians.com directory.</p>

          <h2>2. Eligibility</h2>
          <p>You must be a board-eligible or board-certified geriatrician or senior care specialist in good standing. By applying, you represent that this is true and that all information provided is accurate.</p>
          ...
          <p>You grant TopGeriatricians.com a non-exclusive license to use your submitted content, photos, and website assets for your listing. We may edit or format your listing for consistency with the directory&apos;s standards.</p>
          ...
          <p>TopGeriatricians.com is not responsible for the actions or omissions of any listed professional. The directory is provided for informational purposes only.</p>

          <h2>9. Medical Disclaimer</h2>
          <p>TopGeriatricians.com is a directory for geriatricians and senior care specialists. Listings are not a substitute for medical advice. Users should consult a licensed physician for medical diagnosis and treatment.</p>
          ...
          <h2>11. Contact</h2>
          <p>Questions? Email us at <a href="mailto:info@topgeriatricians.com">info@topgeriatricians.com</a>.</p>
        </div>
      </Container>
    </div>
  );
