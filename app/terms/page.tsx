    ...
    <div className="bg-white min-h-screen py-16">
      <Container>
        <div className="max-w-3xl prose prose-sm prose-headings:font-display prose-headings:text-navy prose-a:text-teal">
          ...
          <h2>2. Eligibility</h2>
          <p>You must be a board-eligible or board-certified nephrologist or kidney specialist in good standing. By applying, you represent that this is true and that all information provided is accurate.</p>
          ...
          <p>TopNephrologists.com is a directory for nephrologists and kidney specialists. Listings are not a substitute for medical advice. Users should consult a licensed physician for medical diagnosis and treatment.</p>
