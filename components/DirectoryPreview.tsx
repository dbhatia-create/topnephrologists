        ...
        <div className="col-span-3 space-y-2">
          <div className="bg-white rounded-lg border border-gray-100 p-2">
            ...
            <p className="text-[9px] text-gray-600 leading-relaxed">
              {company.name} is a top-rated nephrology practice serving the Dallas metro area with comprehensive kidney care for patients, families, and referring physicians.
            </p>
          </div>
          <div className="bg-white rounded-lg border border-gray-100 p-2">
            ...
            {[
              ...
              { name: "Dialysis Care", title: "Fellowship Trained" },
            ].map((o) => (
          ...
          <div className="bg-white rounded-lg border border-gray-100 p-2">
            ...
            <div className="space-y-1.5">
              {[
                ...
                { author: "R. Patel", text: "After my father's CKD diagnosis, this team gave him the best nephrology care we could ask for. Highly recommend." },
              ].map((r) => (
...
const CALLOUTS: Record<View, { color: string; icon: React.ReactNode; text: React.ReactNode }> = {
  featured: {
    ...
    text: <><span className="text-teal font-semibold">Featured Listing</span> — Your practice is pinned as a highlighted banner above all ranked listings. Exclusive — only one provider per city, first-come, first-served.</>,
  },
  profile: {
    color: "bg-navy/5 border-navy/20",
    icon: <TrendingUp className="h-4 w-4 text-teal" />,
    text: <><span className="text-navy font-semibold">Professional Profile Page</span> — Every listed physician gets a dedicated profile with photo, nephrology specialties, kidney care services, reviews, contact details, and your TopNephrologists.com 2026 verified badge.</>,
  },
  directory: {
...
export default function DirectoryPreview() {
  ...
  const browserUrl =
    view === "profile"
      ? "topnephrologists.com/physicians/summit-kidney-care"
        ...
        <FadeIn>
          <div className="text-center mb-10 relative z-40">
            ...
            <p className="text-muted max-w-2xl mx-auto text-lg leading-relaxed">
              Every physician gets a ranked directory listing, a dedicated profile page, and an
